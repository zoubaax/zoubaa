        ...
        <div className="w-full md:w-1/2 space-y text-center md:text-left order-2 md:order-1">
          ...
          <div className="flex justify-center md:justify-start space-x-6 pt-8">
            <a href="https://github.com/zoubaax" className="cursor-target text-gray-600 hover:text-blue-500 transition-all duration-300 flex items-center gap-3 group transform hover:-translate-y-0.5">
              ...
              <span className="text-sm font-medium">{t('home.github', { defaultValue: 'GitHub' })}</span>
            </a>
            ...
            <a href="https://www.linkedin.com/in/zoubaa-mohammed-398266350" className="cursor-target text-gray-600 hover:text-blue-500 transition-all duration-300 flex items-center gap-3 group transform hover:-translate-y-0.5">
              ...
              <span className="text-sm font-medium">{t('home.linkedin', { defaultValue: 'LinkedIn' })}</span>
            </a>
          </div>
        </div>
      </div>
