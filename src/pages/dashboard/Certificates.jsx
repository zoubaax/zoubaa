            ...
            <>
              {certificates.length === 0 ? (
                <div className="text-center py-20">
                  <Award className={`w-20 h-20 mx-auto mb-4 ${isDarkMode ? 'text-gray-500' : 'text-gray-400'
                    }`} />
                      ...
                      <div className="mt-6 flex gap-3">
                        {cert.show_url && (
                          <a
                            ...
                            className={`cursor-target flex-1 flex items-center justify-center gap-2 px-4 py-2 rounded-lg border transition-all group-hover:border-cyan-400/50 ${isDarkMode
