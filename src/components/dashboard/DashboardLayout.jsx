      ...
      <div className={`flex h-screen overflow-hidden transition-colors duration-300 ${
        ...
        <div className="flex flex-col flex-1 overflow-hidden">
          ...
          <header className={`backdrop-blur-lg border-b px-4 sm:px-6 lg:px-8 py-4 flex items-center justify-between transition-colors duration-300 ${
            ...
            <div className="flex items-center gap-4">
              ...
              <button
                ...
                className={`cursor-target lg:hidden p-2 rounded-lg transition-all duration-300 hover:scale-110 ${
                  isDarkMode 
            ...
            <div className="flex items-center gap-3">
              ...
              <button
                onClick={() => navigate('/')}
                className={`cursor-target hidden sm:flex items-center gap-2 px-4 py-2 rounded-lg border transition-all duration-300 hover:scale-105 ${
                  isDarkMode
              ...
              <button
                ...
                className={`cursor-target flex items-center gap-2 px-4 py-2 rounded-lg border transition-all duration-300 hover:scale-105 ${
                  isDarkMode
                    ? 'bg-red-500/20 hover:bg-red-500/30 text-red-400 border-red-400/30'
                    : 'bg-red-500/20 hover:bg-red-500/30 text-red-700 border-red-400/30'
                }`}
          ...
          <main className={`flex-1 overflow-y-auto transition-colors duration-300 ${
            isDarkMode ? 'bg-[#050A30]' : 'bg-[#eff9ff]'
          }`}>
